...
1
hidden_layers_nodes = [40, 35, 30]  # Nodes in each hidden layer
...
iterations = 600  # Number of iterations of the training
...
training_increment_dataset = ListIncrementalDataset("../../datasets_angle_distance/leftArmMovement_train.csv",
                                                    1, n_inputs, n_outputs, ",", 1, 100)

training_dataset = ListClassicDataset("../../datasets_angle_distance/leftArmMovement_train.csv",
                                batch_size, n_inputs, n_outputs, ",", 1)
testing_dataset = ListClassicDataset("../../datasets_angle_distance/leftArmMovement_test.csv", 1,
                               n_inputs, n_outputs, ",", 1)
full_dataset = ListClassicDataset("../../datasets_angle_distance/leftArmMovement_test.csv", 1,
                            n_inputs, n_outputs, ",", 1)
