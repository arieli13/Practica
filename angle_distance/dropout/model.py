...
def create_model(inputs, training):
    ...
    hidden_layer_1, summary_1, saved_variables_1 = create_layer(
        "1", inputs, n_inputs, hidden_layers_nodes[0], True, training, 0.8)
    hidden_layer_2, summary_2, saved_variables_2 = create_layer(
        "2", hidden_layer_1, hidden_layers_nodes[0], hidden_layers_nodes[1], True, training, 0.8)

    output_layer, summary_3, saved_variables_3 = create_layer(
        "output", hidden_layer_2, hidden_layers_nodes[1], n_outputs, True, training, 0.8)
